...
<body>
    ...
    <div class="container-fluid py-3" style="background-color: #f8f9fa;">
        <h2 class="text-center">All Recent Books</h2>
    </div>
    ...
    <div class="container section">
        <div class="row">
            <%
            // Create an instance of BookDAOImpl with the database connection
            BookDAOImpl dao = new BookDAOImpl(DBConnect.getConn());
            // Fetch the list of all recent books from the database
            List<BookDetails> recentBooks = dao.getAllRecentBooks(); // Ensure DAO has this method
